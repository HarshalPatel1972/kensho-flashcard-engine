  ...
  return (
    ...
    >
      ...
      >
        {/* Front Face */}
        <div 
          className="absolute inset-0 bg-surface border-border/50 rounded-2xl p-6 md:p-12 flex flex-col items-center justify-center text-center shadow-[0_4px_24px_rgba(0,0,0,0.08)] dark:shadow-xl flashcard-depth"
        ...
        {/* Back Face */}
        <div 
          className="absolute inset-0 bg-surface border-border/50 dark:border-gold/30 rounded-2xl p-6 md:p-12 flex flex-col items-center justify-center text-center shadow-[0_4px_24px_rgba(0,0,0,0.08)] dark:shadow-2xl dark:shadow-gold/5 flashcard-depth"
          style={{ 
